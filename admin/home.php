...
$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%Tanaman Hias Meja%'");
$hasil=mysqli_num_rows($query);

$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%crown%'");
$hasil1=mysqli_num_rows($query);

$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%bouquet%'");
$hasil2=mysqli_num_rows($query);

$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%nyamuk%'");
$hasil3=mysqli_num_rows($query);

$query=mysqli_query($conn, "SELECT * FROM tbl_barang WHERE nama LIKE '%flowers%'");
          ...
          ?>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="#pageSubmenu1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-fw fa-male"></i>Bunga Mati<i class="fa fa-fw fa-caret-down"></i></a>
...
// komentar
    ...
    data: [{
        ...
        indexLabel: "{label} - {y}%",
        dataPoints: [
        { y: <?= $hasil; ?>, label: "Tanaman Hias Meja" },
        { y: <?= $hasil1; ?>, label: "Crown" },
        { y: <?= $hasil2 ?>, label: "Bouquet" },
        { y: <?= $hasil3; ?>, label: "Tanaman Penghusir Nyamuk" },
        { y: <?= $hasil4; ?>, label: "Macam Macam Bunga" }
        ]
    }]
});
            chart.render();
